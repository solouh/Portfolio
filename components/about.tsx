...
const experiences = [
  {
    ...
    description: "Building responsive web apps and UI components with React, Next.js, and Tailwind CSS.",
    active: true,
  },
  {
    period: "2021 — 2023",
    title: "IT Student — Foundation Phase",
    org: "Self-Learning & Academics",
    description: "Mastered Python and Java fundamentals, built CLI tools, and explored algorithms.",
    active: false,
  },
];
...
const education = [
  {
    ...
    description: "Python, Java, programming logic, and computer science fundamentals.",
    active: true,
  },
  {
    period: "2025 — Present",
    ...
    org: "Phinma COC Puerto",
    description: "Web development, networking, database design, and system architecture.",
    active: true,
  },
  {
    period: "2027 — 2028",
    ...
    org: "Phinma COC Puerto",
    description: "Capstone projects, industry immersion, and professional portfolio development.",
    active: false,
  },
];
...
const goals = [
  {
    ...
    description: "Deepen expertise in Next.js, Node.js, and PostgreSQL to build production-grade applications.",
    timeframe: "2025 — 2026",
  },
  {
    icon: Globe,
  ...
  },
  {
    ...
    description: "Build and deploy a real-world SaaS application with real users and revenue.",
    timeframe: "2027 — 2028",
  },
  {
    icon: Award,
    title: "Industry Certification",
    description: "Earn cloud and DevOps certifications (AWS, Docker) to strengthen professional credibility.",
    timeframe: "2026 — 2027",
  },
];
    ...
    <section className="animate-in fade-in slide-in-from-bottom-6 duration-700 space-y-10 sm:space-y-14 max-w-5xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed text-base sm:text-lg max-w-2xl">
          An IT student passionate about building modern web experiences. Focused
          on performance, clean code, and continuous learning.
        </p>
