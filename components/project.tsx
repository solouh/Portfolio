...
export default function ProjectsSection({ projects = defaultProjects }: { projects?: Project[] }) {
    ...
    <section className="space-y-8 my-12 max-w-5xl mx-auto px-4 sm:px-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed text-base sm:text-lg max-w-2xl">
          A few things shipped recently. Built with focus on performance, clean code, and user experience.
        </p>
      </div>
      ...
      {isEmpty ? (
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-neutral-300 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-900/30 py-16 px-4 text-center">
          ...
          <h3 className="text-sm font-semibold text-neutral-900 dark:text-neutral-100">No projects yet</h3>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project) => (
            ...
            >
              <Card className="overflow-hidden h-full border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900/50 
